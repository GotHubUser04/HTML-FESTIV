...
<head>
  ...
  <title>Festivals in Rizal</title>
  <style>
    ...
    body {
      ...
      background: linear-gradient(to right, #caf229, #efe229, #f2c329, #f29429, #f45525);
      margin: 0;
      padding: 0;
      color: #1f2937;
      overflow-x: hidden;
    ...
    .banner::before {
      ...
      right: 0;
      bottom: 0;
      background-image: url('imagesfestival/province of rizal (2).png');
...
<!-- Toggle Button for Festival List -->
...
<section id="festivalDetails">
  ...
  <div class="festival-info" id="kakanin">
  ...
  <div class="festival-info" id="aruga">
    <h3>Aruga Festival – Angono</h3>
    <p>A cultural tribute to caregiving and Filipino compassion through street art and musical showcases.</p>
    <p><strong>Date:</strong> September</p>
    <p><strong>Location:</strong> Angono, Rizal</p>
  </div>

  <div class="festival-info" id="salubong">
    <h3>Salubong Festival – Taytay</h3>
    <p>Highlights Taytay’s Christian heritage with dawn processions and reenactments of biblical events.</p>
    <p><strong>Date:</strong> Easter Sunday</p>
    <p><strong>Location:</strong> Taytay, Rizal</p>
   
   </ul>
  </div>
</section>

<!-- Styling for Festival Info -->
<style>
  .festival-info {
    display: none;
    margin-top: 20px;
...
<!-- Script to Toggle Street Dancing Section -->
<script>
...
<!-- Script to Toggle Parade Section -->
<script>
...
<!-- Script to Toggle Festival List and Show Info -->
<script>
...
<!-- Parade Toggle Button -->
        <button class="parade-button" onclick="toggleParades()" id="paradeToggle">Parade Festivals</button>
      </ul>        
<!-- Parade Activity Section -->
    ...
    <p>Whether you're a local or a visitor, joining these celebrations is a meaningful way to experience Filipino traditions, creativity, and community spirit.</p>
  </section>
...
<section id="festivalInfo" class="festival-info">
  ...
  <!-- Facebook SDK (include only once per page, ideally after <body>) -->
  <div id="fb-root"></div>
  ...
  <section id="festival4" class="festival-section">
